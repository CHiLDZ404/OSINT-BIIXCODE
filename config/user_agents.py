"""
BIIXCODE OSINT - User Agents Configuration
Koleksi user agents untuk menghindari deteksi
"""
...
def get_agent_by_browser(browser="chrome"):
    """Get user agent by specific browser"""
    agents = {
    ...
    return agents.get(browser.lower(), get_random_agent())